...
## It restricts to DMRs with enforceable limits
...
icis_permits2 <- icis_permits2 %>%
  select(external_permit_nmbr, version_nmbr, 
         permit_status_code, component_type_desc)
...
flow_icis <- flow_icis %>%
  ...
  mutate(flow_over_design = flow_correct / total_design_flow_nmbr,
         design_flow_round = plyr::round_any(total_design_flow_nmbr, 0.1, floor),
...
a <- ggplot(flow_icis2, aes(x = design_flow_round, y = mean_flow, size = num_in_bin)) +
...
b <- ggplot(flow_icis2, aes(x = design_flow_round, y = mean_flow_over_design, size = num_in_bin)) +
  geom_point(color = "#0082CB", alpha = 0.8) +
...
c <- ggplot(flow_icis2, aes(x = design_flow_round, y = median_flow, size = num_in_bin)) +
...
d <- ggplot(flow_icis2, aes(x = design_flow_round, y = median_flow_over_design, size = num_in_bin)) +
  geom_point(color = "#0082CB") +
  annotate("text", x = 1.15, y = 1, label = "1 MGD", size = 10) +
  geom_vline(xintercept = 1, linetype = 2) +
  labs(size = "No. Permits in Bin" ) +
...
dir_create_if_not_exist("results","enf_limit_type")
  


# BOD plots ----
  
BOD_c2 <- prep_mean_conc(type = c2_mod, pollutant = "BOD")
BOD_c3 <- prep_max_conc(type = c3_mod, pollutant = "BOD")
BOD_q1 <- prep_mean_quant(type = q1_mod, pollutant = "BOD")
BOD_q2 <- prep_max_quant(type = q2_mod, pollutant = "BOD")
...
plot
ggsave(here::here("results", "enf_limit_type", "BOD_mean_conc_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "BOD_mean_max_conc_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "BOD_mean_quant_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "BOD_mean_max_quant_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")



# DO plots ----

DO_c2 <- prep_mean_conc(type = c2_mod, pollutant = "DO")
DO_c3 <- prep_max_conc(type = c3_mod, pollutant = "DO")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "DO_mean_conc_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "DO_mean_max_conc_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
...
TSS_c2 <- prep_mean_conc(type = c2_mod, pollutant = "TSS")
TSS_c3 <- prep_max_conc(type = c3_mod, pollutant = "TSS")
TSS_q1 <- prep_mean_quant(type = q1_mod, pollutant = "TSS")
TSS_q2 <- prep_max_quant(type = q2_mod, pollutant = "TSS")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "TSS_mean_conc_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "TSS_mean_max_conc_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "TSS_mean_quant_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
...
plot <- plot + theme(plot.margin = margin(1,1,1.5,1.2,"cm"))
plot
ggsave(here::here("results", "enf_limit_type", "TSS_mean_max_quant_by_design_flow.png"), dpi = 300, plot=plot, h = 8.5, w = 11, units = "in", bg = "white")
